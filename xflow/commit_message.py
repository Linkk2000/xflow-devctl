...
def check_commit_message(
    ...
    path_scan = REMOTE_URL_RE.sub("", message)
    if (
        LOCAL_FILE_URI_RE.search(path_scan)
        or WINDOWS_ABSOLUTE_PATH_RE.search(path_scan)
